# ncm.artist_detail_dynamic / artist_detail_dynamic

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`b4b4e9d9e5fb2e90749047ce9e43eb1c9b3f9a852e5f93acb88a75c450758e1f`（pkg）
- 导出名：artist_detail_dynamic
- 路由或调用方式：`/api/artist/detail/dynamic`
...
- 源码：module/artist_detail_dynamic.js（注释：歌手动态信息）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/artist/detail/dynamic
- 官方测试：未发现直接引用
...
| --- | --- | --- | --- | --- | --- |
| ncm.artist_detail_dynamic.anon.001 | AUTH_ANON | - | 200 | 205 |  |
