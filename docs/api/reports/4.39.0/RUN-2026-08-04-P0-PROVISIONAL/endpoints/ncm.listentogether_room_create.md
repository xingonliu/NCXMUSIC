# ncm.listentogether_room_create / listentogether_room_create

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`b85d8955bcb228026e3c06c90ad868d40698ea7832d432b48807e541896c2ac4`（pkg）
- 导出名：listentogether_room_create
- 路由或调用方式：`/api/listen/together/room/create`
...
- 源码：module/listentogether_room_create.js（注释：一起听创建房间）
...
| --- | --- | --- | --- | --- | --- |
| ncm.listentogether_room_create.anon.001 | AUTH_ANON | - | 200 | 239 |  |
| ncm.listentogether_room_create.inv.001 | AUTH_INVALID_EXPIRED | err | 301 | - | code 301 |
| ncm.listentogether_room_create.none.001 | AUTH_NONE | err | 301 | - | code 301 |
| ncm.listentogether_room_create.none.002 | AUTH_NONE | err | 301 | - | code 301 |
...
| `data.avatarPendantShow` | boolean | 1 | 0 | 0 | AUTH_ANON | `true` |
| `data.hintText` | null | 1 | 1 | 0 | AUTH_ANON |  |
| `data.inviteUserInfo` | null | 1 | 1 | 0 | AUTH_ANON |  |
...
| `data.toastText` | null | 1 | 1 | 0 | AUTH_ANON |  |
| `data.type` | string | 1 | 0 | 0 | AUTH_ANON | `NEW_ROOM` |
