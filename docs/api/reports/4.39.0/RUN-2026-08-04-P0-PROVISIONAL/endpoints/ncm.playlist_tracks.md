# ncm.playlist_tracks / playlist_tracks

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`882688ccb3053cf93910d1ab8d80ebacb7e89309145191fcee747b4b12714a8c`（pkg）
- 导出名：playlist_tracks
- 路由或调用方式：`/api/playlist/manipulate/tracks`
...
- 源码：module/playlist_tracks.js（注释：收藏单曲到歌单 从歌单删除歌曲）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/playlist/tracks
- 官方测试：未发现直接引用
...
| --- | --- | --- | --- | --- |
| tracks | string | 未发现默认值 | 源码读取 query.tracks |
| op | string | 未发现默认值 | 源码读取 query.op |
