# ncm.personalized_privatecontent_list / personalized_privatecontent_list

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`148632917a44b7404c9fb1974eaeba9cea83e641f2eda757639ecfb9ea3e4a5e`（pkg）
- 导出名：personalized_privatecontent_list
- 路由或调用方式：`/api/v2/privatecontent/list`
...
- 源码：module/personalized_privatecontent_list.js（注释：独家放送列表）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/personalized/privatecontent/list
- 官方测试：未发现直接引用
...
| limit | string | 可选（默认 `60`） | 源码读取 query.limit |
