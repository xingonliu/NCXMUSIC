# ncm.comment_dj / comment_dj

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`9d5d445ca307b5fac1a265f4bdfc81aaf8bd7a6013df2f15d4376ce3b02b775b`（pkg）
- 导出名：comment_dj
- 路由或调用方式：`/api/v1/resource/comments/A_DJ_1_${query.id} (templated)`
...
- 源码：module/comment_dj.js（注释：电台评论）
