# ncm.song_download_url / song_download_url

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`0c9fb7824573bdc91a24c2be31aee8b21e81ec98801177629836a4508d087810`（pkg）
- 导出名：song_download_url
- 路由或调用方式：`/api/song/enhance/download/url`
...
- 源码：module/song_download_url.js（注释：获取客户端歌曲下载链接）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/song/download/url
- 官方测试：未发现直接引用
...
| --- | --- | --- | --- | --- | --- |
| ncm.song_download_url.A.anon.001 | AUTH_ANON | - | 200 | 112 |  |
| ncm.song_download_url.A.id0.none.neg.001 | AUTH_NONE | err | -462 | - | code -462 |
| ncm.song_download_url.A.none.001 | AUTH_NONE | err | -462 | - | code -462 |
| ncm.song_download_url.B.none.001 | AUTH_NONE | err | -462 | - | code -462 |
