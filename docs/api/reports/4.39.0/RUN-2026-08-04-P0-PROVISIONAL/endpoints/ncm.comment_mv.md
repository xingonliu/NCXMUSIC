# ncm.comment_mv / comment_mv

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`e412c1ba6bdf7230d690cffc1c6f25cbfbe6a9394ddc9c2c937192c9949e5acc`（pkg）
- 导出名：comment_mv
- 路由或调用方式：`/api/v1/resource/comments/R_MV_5_${query.id} (templated)`
...
- 源码：module/comment_mv.js（注释：MV评论）
