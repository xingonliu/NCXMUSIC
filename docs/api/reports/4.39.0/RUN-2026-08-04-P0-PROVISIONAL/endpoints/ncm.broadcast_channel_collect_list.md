# ncm.broadcast_channel_collect_list / broadcast_channel_collect_list

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`f93bc83e86f034cfc468b367d5abf1a8152c5d6d569eedf7189e8e358c7e9088`（pkg）
- 导出名：broadcast_channel_collect_list
- 路由或调用方式：`/api/content/channel/collect/list`
...
- 源码：module/broadcast_channel_collect_list.js（注释：广播电台 - 我的收藏）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/broadcast/channel/collect/list
- 官方测试：未发现直接引用
...
| --- | --- | --- | --- | --- |
| limit | string | 可选（默认 `99999`） | 源码读取 query.limit |
