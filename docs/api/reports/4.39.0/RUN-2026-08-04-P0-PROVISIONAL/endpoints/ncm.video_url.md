# ncm.video_url / video_url

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`4f3b8ed8ff3e9306a3e77f3fade92401d56689ab366003b4d6d7bb1180f257c2`（pkg）
- 导出名：video_url
- 路由或调用方式：`/api/cloudvideo/playurl`
...
- 源码：module/video_url.js（注释：视频链接）
...
| res | string | 可选（默认 `1080`） | 源码读取 query.res |
