# ncm.user_account / user_account

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`2fa3cb37934066edcdc5b528f0a346dbf446a03f6af74ef8e1ce280124ddb388`（pkg）
- 导出名：user_account
- 路由或调用方式：`/api/nuser/account/get`
...
- 源码：module/user_account.js
- 类型：interface.d.ts 有函数声明
- 文档：docs:/user/account
- 官方测试：未发现直接引用
