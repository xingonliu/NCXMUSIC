# ncm.simi_playlist / simi_playlist

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`778d3532fb192a092943ba0cb6b80f211826b79a7f001a319638213a4e715368`（pkg）
- 导出名：simi_playlist
- 路由或调用方式：`/api/discovery/simiPlaylist`
...
- 源码：module/simi_playlist.js（注释：相似歌单）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/simi/playlist
- 官方测试：未发现直接引用
...
| --- | --- | --- | --- | --- | --- |
| ncm.simi_playlist.anon.001 | AUTH_ANON | - | 200 | 110 |  |
