# ncm.register_xeapikey / register_xeapikey

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`507a169b3f1574d058f51d018ff2a6657f54341d827b938b6828f814ad1226a6`（pkg）
- 导出名：register_xeapikey
- 路由或调用方式：`direct-call`
...
- 源码：module/register_xeapikey.js
...
| --- | --- | --- | --- | --- |
| deviceId | string | 未发现默认值 | 源码读取 query.deviceId |
| currentKeyVersion | string | 未发现默认值 | 源码读取 query.currentKeyVersion |
