# ncm.song_music_detail / song_music_detail

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`1198571f77aaeba37ffa9f1bb932f2cd519dd418fa336c090cd065800855dc82`（pkg）
- 导出名：song_music_detail
- 路由或调用方式：`/api/song/music/detail/get`
...
- 源码：module/song_music_detail.js（注释：歌曲音质详情）
- 类型：interface.d.ts 有函数声明
- 文档：docs:/song/music/detail
- 官方测试：未发现直接引用
...
| --- | --- | --- | --- | --- | --- |
| ncm.song_music_detail.anon.001 | AUTH_ANON | - | 400 | 131 |  |
