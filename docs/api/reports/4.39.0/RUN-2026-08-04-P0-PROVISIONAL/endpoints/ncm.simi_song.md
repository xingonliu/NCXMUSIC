# ncm.simi_song / simi_song

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`fb69376cdc70a47389af70c7b57d81cebfeb608453382f1e7a51d6dfb749ed95`（pkg）
- 导出名：simi_song
- 路由或调用方式：`/api/v1/discovery/simiSong`
...
- 源码：module/simi_song.js（注释：相似歌曲）
