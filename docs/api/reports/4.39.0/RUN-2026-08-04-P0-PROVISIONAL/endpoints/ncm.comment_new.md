# ncm.comment_new / comment_new

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`5434cdaf8854cd77d654fc54a3588752a1912a34922d3974fe40b73dbde82348`（pkg）
- 导出名：comment_new
- 路由或调用方式：`/api/v2/resource/comments`
...
- 源码：module/comment_new.js（注释：评论）
...
| pageSize | string | 未发现默认值 | 源码读取 query.pageSize |
| pageNo | string | 未发现默认值 | 源码读取 query.pageNo |
| sortType | string | 未发现默认值 | 源码读取 query.sortType |
| cursor | string | 未发现默认值 | 源码读取 query.cursor |
| showInner | string | 未发现默认值 | 源码读取 query.showInner |
