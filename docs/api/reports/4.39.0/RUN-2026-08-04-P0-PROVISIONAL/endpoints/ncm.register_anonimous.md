# ncm.register_anonimous / register_anonimous

## 1. 元数据

- 包版本：4.39.0（provisional 锚点）
- 模块校验和：`a3211a71bf02bdee0bf56e85c95347485b4898abaf46e1d70c4cfc22bb3248a7`（pkg）
- 导出名：register_anonimous
- 路由或调用方式：`/api/register/anonimous`
...
- 源码：module/register_anonimous.js（注释：获取游客cookie）
...
| --- | --- | --- | --- | --- | --- | --- |
| `code` | number | 2 | 0 | 0 | AUTH_NONE | `400` |
