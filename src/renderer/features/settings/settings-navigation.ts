...
export const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  { tab: 'music', title: '当前歌词位置', description: '选择沉浸歌词焦点靠上、居中或靠下。', targetId: 'setting-lyric-alignment', keywords: ['歌词', '对齐', '位置', '焦点'] },
  { tab: 'music', title: '歌词动效', description: '选择完整、轻柔或简洁歌词动效。', targetId: 'setting-lyric-motion', keywords: ['歌词', '动画', '弹簧', '模糊', '缩放'] },
  { tab: 'music', title: '歌词字号', description: '选择紧凑、标准、大号或超大号沉浸歌词。', targetId: 'setting-lyric-font-size', keywords: ['歌词', '字体', '字号', '大小', '超大号'] },
  { tab: 'music', title: '歌词字重', description: '选择从细到超粗体的歌词粗细。', targetId: 'setting-lyric-font-weight', keywords: ['歌词', '字体', '字重', '粗体', '粗细'] },
  { tab: 'music', title: '已唱歌词', description: '选择是否隐藏已经演唱完毕的歌词。', targetId: 'setting-hide-passed-lyrics', keywords: ['歌词', '隐藏', '已唱', '历史'] },
  ...
  { tab: 'voice', title: '全局按住说话', description: '设置全局语音快捷键。', targetId: 'setting-voice-shortcut', keywords: ['快捷键', '按住说话', 'alt space'] },
  { tab: 'voice', title: '麦克风', description: '查看状态并打开系统麦克风权限。', targetId: 'setting-microphone', keywords: ['权限', '录音', 'microphone'] },
  { tab: 'voice', title: '云端 ASR', description: '查看当前模型的语音识别能力。', targetId: 'setting-cloud-asr', keywords: ['语音识别', 'asr', '模型'] },
  { tab: 'voice', title: '音频数据边界', description: '了解原始录音的存储和释放方式。', targetId: 'setting-audio-boundary', keywords: ['隐私', '录音', '数据', 'tts'] },
